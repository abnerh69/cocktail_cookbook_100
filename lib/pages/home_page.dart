        ...
        child: SafeArea(
          child: Stack(
            ...
            children: <Widget>[
              ...
              if (DIM.theCocktailCookbookData.lRandomDrink)
                Image.network(
                    DIM.theCocktailCookbookData.randomDrink!.drinkThumb),
              if (DIM.theCocktailCookbookData.lRandomDrink)
                InkWell(
                  child: AnimatedSwitcher(
                      duration: const Duration(milliseconds: 200),
                      child: Container(
                        key: ValueKey<int>(DIM
                                .theCocktailCookbookData.randomDrink!.idDrink
                                .toInt() ??
                            0),
                        // decoration: BoxDecoration(
                        //   image: DecorationImage(
                        ...
                        child: frostedIconButton(IconButton(
                          icon: Icon(Icons.refresh_outlined,
                              color: selectedIngredients
                                  ...
                                  : Colors.white70),
                          onPressed: () async {
                            await DIM.theCocktailCookbookData
